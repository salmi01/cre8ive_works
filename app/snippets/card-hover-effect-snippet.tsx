...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Capture moments with professional, high-quality visuals tailored to your needs, from events to brand content.",
  ...
  },
  {
    ...
    title: "Social Media",
    description:
      "We offer social media management and content creation services. We can help you grow your social media presence and reach new customers.",
  ...
  },
  {
    ...
    description:
      "Create stunning visuals that captivate and communicate your brand’s message effectively across all platforms.",
